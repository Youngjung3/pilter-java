...
public class AlarmAddActivity extends AppCompatActivity {
    ...
    Button timeplus, cancel_btn, save_btn, start, end;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(AlarmAddActivity.this, R.style.DialogTheme, mDateSetListener, mYear, mMonth, mDay).show();
            }
            ...
            void UpdateNow() {
                Toast toast3 = new Toast(AlarmAddActivity.this);
                View toastView3 = (View) View.inflate(AlarmAddActivity.this, R.layout.toast, null);
        ...
        for (i = 0; i < dayID.length; i++) {
            ...
            day[index].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (day[index].getCurrentTextColor() == Color.WHITE) {
                        day[index].setBackgroundResource(R.drawable.btn1);
                        day[index].setTextColor(Color.BLACK);
                        day_array[index] = 1;
                    } else {
                        day[index].setBackgroundResource(R.drawable.btn2);
        ...
        for (k = 0; k < timePickID.length; k++) {
            timePick[k] = (View) View.inflate(AlarmAddActivity.this, timePickID[k], null);
        ...
        for (k = 0; k < timePickID.length; k++) {
            ...
            timeSet[index].setOnClickListener(new View.OnClickListener() {
                @SuppressWarnings("deprecation")
                public void onClick(View view) {
                    AlertDialog.Builder dlg1 = new AlertDialog.Builder(AlarmAddActivity.this, R.style.DialogTheme);
                    dlg1.setTitle("시간선택");
            ...
            save_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (name.getText().toString() == null || startday == null || endday == null || timesPerDay == null ||
                        ...
                        Log.d("endday", endday);
                        Log.d("timesPerDay", String.valueOf(timesPerDay));
                        Log.d("time_array", String.valueOf(time_array[0]));
                        Log.d("day_array", String.valueOf(day_array[3]));
                       ...
                       Toast.makeText(getApplicationContext(),"모든 항목을 입력해주세요",Toast.LENGTH_SHORT).show();
                        ...
                        startService(new Intent(AlarmAddActivity.this, MyService.class));
